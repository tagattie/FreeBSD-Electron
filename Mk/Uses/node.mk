...
_VALID_NODE_VERSIONS=	10 12 14 16
...
_NODE_RELPKGNAME=	node
_NPM_RELPKGNAME=	npm
_YARN_RELPKGNAME=	yarn
...
_NODE_PKGNAME=		${_NODE_RELPKGNAME}
_NPM_PKGNAME=		${_NPM_RELPKGNAME}
_YARN_PKGNAME=		${_YARN_RELPKGNAME}
...
_NODE_PKGNAME=		${_NODE_RELPKGNAME}${_NODE_VERSION}
_NPM_PKGNAME=		${_NPM_RELPKGNAME}-node${_NODE_VERSION}
_YARN_PKGNAME=		${_YARN_RELPKGNAME}-node${_NODE_VERSION}
.   else
...
NODE_PKGNAME=		${_NODE_PKGNAME}
NPM_PKGNAME=		${_NPM_PKGNAME}
YARN_PKGNAME=		${_YARN_PKGNAME}
