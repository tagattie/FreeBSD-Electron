--- electron/spec/api-browser-window-spec.ts.orig	2023-11-15 10:20:22 UTC
...
@@ -5167,7 +5167,7 @@ describe('BrowserWindow module', () => {
     });
   });
...
@@ -6321,7 +6321,7 @@ describe('BrowserWindow module', () => {
