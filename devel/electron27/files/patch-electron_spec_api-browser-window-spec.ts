--- electron/spec/api-browser-window-spec.ts.orig	2023-10-20 08:29:17 UTC
...
@@ -1099,7 +1099,7 @@ describe('BrowserWindow module', () => {
...
+      ifit(process.platform !== 'linux' && process.platform !== 'freebsd')('should not be visible when the window is minimized', async () => {
         ...
         w.minimize();
         await minimize;
@@ -1116,7 +1116,7 @@ describe('BrowserWindow module', () => {
       });
...
+      ifit(process.platform !== 'linux' && process.platform !== 'freebsd')('should not restore maximized windows', async () => {
         ...
         w.maximize();
@@ -1153,7 +1153,7 @@ describe('BrowserWindow module', () => {
...
@@ -1220,7 +1220,7 @@ describe('BrowserWindow module', () => {
...
+      ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('Maximized state', () => {
         it('checks normal bounds when maximized', async () => {
           ...
           const maximize = once(w, 'maximize');
@@ -1811,7 +1811,7 @@ describe('BrowserWindow module', () => {
         });
       });
...
+      ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('Minimized state', () => {
         it('checks normal bounds when minimized', async () => {
           const bounds = w.getBounds();
           const minimize = once(w, 'minimize');
@@ -2798,7 +2798,7 @@ describe('BrowserWindow module', () => {
...
@@ -2824,7 +2824,7 @@ describe('BrowserWindow module', () => {
       });
     });
...
@@ -4258,7 +4258,7 @@ describe('BrowserWindow module', () => {
     });
   });
...
+  ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('max/minimize events', () => {
     ...
     it('emits an event when window is maximized', async () => {
       const w = new BrowserWindow({ show: false });
@@ -4529,7 +4529,7 @@ describe('BrowserWindow module', () => {
     // TODO(zcbenz):
...
+    ifit((process.platform === 'linux' || process.platform === 'freebsd') && !process.env.CI)('should bring a minimized maximized window back to maximized state', async () => {
       ...
       const maximize = once(w, 'maximize');
       w.maximize();
@@ -4546,7 +4546,7 @@ describe('BrowserWindow module', () => {
   });
...
+    ifit(process.platform !== 'linux' && process.platform !== 'freebsd')('should not restore a minimized window', async () => {
       ...
       const minimize = once(w, 'minimize');
       w.minimize();
@@ -5057,7 +5057,7 @@ describe('BrowserWindow module', () => {
       });
...
@@ -5147,7 +5147,7 @@ describe('BrowserWindow module', () => {
     });
   });
...
@@ -6301,7 +6301,7 @@ describe('BrowserWindow module', () => {
