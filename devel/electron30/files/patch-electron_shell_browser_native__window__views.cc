--- electron/shell/browser/native_window_views.cc.orig	2024-04-16 14:29:17 UTC
...
@@ -292,7 +292,7 @@ NativeWindowViews::NativeWindowViews(const gin_helper:
...
@@ -1338,7 +1338,7 @@ void NativeWindowViews::SetParentWindow(NativeWindow* 
...
@@ -1384,7 +1384,7 @@ void NativeWindowViews::SetProgressBar(double progress
...
@@ -1455,7 +1455,7 @@ bool NativeWindowViews::IsVisibleOnAllWorkspaces() con
 }
...
@@ -1478,7 +1478,7 @@ content::DesktopMediaID NativeWindowViews::GetDesktopM
 #if BUILDFLAG(IS_WIN)
   window_handle =
...
@@ -1576,7 +1576,7 @@ void NativeWindowViews::SetIcon(HICON window_icon, HIC
...
@@ -1654,7 +1654,7 @@ bool NativeWindowViews::CanMinimize() const {
...
@@ -1706,7 +1706,7 @@ void NativeWindowViews::HandleKeyboardEvent(
...
@@ -1725,7 +1725,7 @@ void NativeWindowViews::OnMouseEvent(ui::MouseEvent* e
