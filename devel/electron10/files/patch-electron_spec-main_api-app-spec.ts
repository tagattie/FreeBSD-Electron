--- electron/spec-main/api-app-spec.ts.orig	2021-01-14 16:50:03 UTC
...
@@ -320,7 +320,7 @@ describe('app module', () => {
   //   let w = null
...
@@ -794,7 +794,7 @@ describe('app module', () => {
     let w: BrowserWindow;
...
@@ -951,7 +951,7 @@ describe('app module', () => {
...
@@ -1008,7 +1008,7 @@ describe('app module', () => {
   });
...
+  ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('getFileIcon() API', () => {
     ...
     const sizes = {
       small: 16,
@@ -1081,7 +1081,7 @@ describe('app module', () => {
