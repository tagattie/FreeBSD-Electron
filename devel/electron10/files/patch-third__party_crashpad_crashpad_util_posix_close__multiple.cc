--- third_party/crashpad/crashpad/util/posix/close_multiple.cc.orig	2020-09-21 18:39:53 UTC
...
@@ -180,11 +180,37 @@ void CloseMultipleNowOrOnExec(int fd, int preserve_fd)
   }
 #endif
