--- electron/shell/app/electron_main_delegate.cc.orig	2020-03-02 19:30:38 UTC
...
@@ -205,7 +205,7 @@ bool ElectronMainDelegate::BasicStartupComplete(int* e
     base::win::PinUser32();
 #endif
...
@@ -245,7 +245,7 @@ void ElectronMainDelegate::PostEarlyInitialization(boo
