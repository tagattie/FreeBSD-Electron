--- chrome/browser/ui/views/profiles/first_run_flow_controller.cc.orig	2026-06-23 23:37:18 UTC
...
@@ -760,7 +760,7 @@ void FirstRunFlowController::MaybeTriggerHatsSurvey() 
 }
