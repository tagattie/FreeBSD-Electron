--- electron/shell/browser/api/electron_api_safe_storage.cc.orig	2026-06-29 20:35:15 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -148,7 +148,7 @@ bool SafeStorage::IsEncryptionAvailable() {
...
@@ -168,7 +168,7 @@ v8::Local<v8::Promise> SafeStorage::IsAsyncEncryptionA
     return handle;
   }
...
@@ -191,7 +191,7 @@ void SafeStorage::SetUsePasswordV10(bool use) {
