--- chrome/common/chrome_features.cc.orig	2026-06-23 23:37:18 UTC
...
@@ -174,7 +174,7 @@ BASE_FEATURE(kShowResetProfileBannerV2, base::FEATURE_
...
@@ -1279,7 +1279,7 @@ BASE_FEATURE(kIsolatedWebAppBundleCache, base::FEATURE
