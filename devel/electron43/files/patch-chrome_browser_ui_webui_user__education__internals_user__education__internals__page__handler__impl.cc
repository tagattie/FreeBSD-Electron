--- chrome/browser/ui/webui/user_education_internals/user_education_internals_page_handler_impl.cc.orig	2026-06-23 23:37:18 UTC
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
   return nullptr;
@@ -863,7 +863,7 @@ void UserEducationInternalsPageHandlerImpl::LaunchWhat
 }
