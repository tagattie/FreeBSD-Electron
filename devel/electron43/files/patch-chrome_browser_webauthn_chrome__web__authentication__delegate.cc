--- chrome/browser/webauthn/chrome_web_authentication_delegate.cc.orig	2026-06-23 23:37:18 UTC
...
@@ -379,7 +379,7 @@ ChromeWebAuthenticationDelegate::MaybeGetRequestProxy(
