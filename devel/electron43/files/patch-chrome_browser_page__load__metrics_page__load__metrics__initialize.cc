--- chrome/browser/page_load_metrics/page_load_metrics_initialize.cc.orig	2026-06-23 23:37:18 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -353,7 +353,7 @@ bool PageLoadMetricsEmbedder::ShouldObserveScheme(std:
