--- chrome/browser/ui/views/frame/opaque_browser_frame_view.cc.orig	2026-06-23 23:37:18 UTC
...
@@ -599,7 +599,7 @@ OpaqueBrowserFrameView::GetFrameButtonStyle() const {
...
@@ -862,7 +862,7 @@ void OpaqueBrowserFrameView::WindowIconPressed() {
 }
