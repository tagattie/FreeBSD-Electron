--- content/app/content_main_runner_impl.cc.orig	2026-07-07 05:57:55 UTC
...
+
 ...
 #include "base/system/sys_info.h"
@@ -372,7 +379,7 @@ void InitializeZygoteSandboxForBrowserProcess(
 }
...
@@ -391,7 +398,10 @@ void PreSandboxInit() {
...
+#endif
   ...
   // files.
@@ -403,9 +413,16 @@ void PreSandboxInit() {
...
@@ -997,7 +1013,7 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
...
@@ -1032,7 +1048,7 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
     // SeatbeltExecServer.
...
@@ -1046,6 +1062,16 @@ int ContentMainRunnerImpl::Initialize(ContentMainParam
...
@@ -1162,6 +1188,11 @@ NO_STACK_PROTECTOR int ContentMainRunnerImpl::Run() {
