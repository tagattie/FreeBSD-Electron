--- gpu/config/gpu_finch_features.cc.orig	2026-06-23 23:37:18 UTC
+++ gpu/config/gpu_finch_features.cc
@@ -111,7 +111,7 @@ BASE_FEATURE(kRemoveGPULegacyIPC, base::FEATURE_DISABL
...
@@ -120,7 +120,7 @@ BASE_FEATURE(kNvidiaWaylandYuvHardwareConversionWorkar
...
@@ -449,7 +449,7 @@ const base::FeatureParam<int> kGPUDriverBugListTestGro
