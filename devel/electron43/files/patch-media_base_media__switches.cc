--- media/base/media_switches.cc.orig	2026-06-23 23:37:18 UTC
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -739,7 +761,7 @@ BASE_FEATURE(kUnifiedAutoplay, base::FEATURE_ENABLED_B
 // autoplay policy.
...
@@ -817,7 +839,7 @@ BASE_FEATURE(kVSyncMjpegDecoding, base::FEATURE_DISABL
...
+#if BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 BASE_FEATURE(kV4L2H264TemporalLayerHWEncoding,
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -1016,7 +1038,7 @@ BASE_FEATURE(kHardwareMediaKeyHandling,
...
+#elif BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
              ...
              base::FEATURE_ENABLED_BY_DEFAULT
 #else
@@ -1380,7 +1402,7 @@ BASE_FEATURE(kUseSharedImageInOOPVDProcess, base::FEAT
...
@@ -1442,7 +1464,7 @@ BASE_FEATURE(kRecordWebAudioEngagement, base::FEATURE_
