--- chrome/browser/ui/views/frame/browser_widget.cc.orig	2026-06-23 23:37:18 UTC
...
@@ -534,7 +534,7 @@ void BrowserWidget::SelectNativeTheme() {
 }
...
@@ -575,7 +575,7 @@ bool BrowserWidget::RegenerateFrameOnThemeChange(
