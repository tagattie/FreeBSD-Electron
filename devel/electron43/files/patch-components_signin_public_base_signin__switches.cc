--- components/signin/public/base/signin_switches.cc.orig	2026-06-23 23:37:18 UTC
...
@@ -573,12 +573,12 @@ BASE_FEATURE(kNonDefaultGaiaOriginCheck, base::FEATURE
...
@@ -689,7 +689,7 @@ BASE_FEATURE(kSupportAddSessionEmailPrefill, base::FEA
