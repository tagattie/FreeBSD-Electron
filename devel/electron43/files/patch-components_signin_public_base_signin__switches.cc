--- components/signin/public/base/signin_switches.cc.orig	2026-07-07 17:43:50 UTC
...
@@ -580,12 +580,12 @@ BASE_FEATURE(kNonDefaultGaiaOriginCheck, base::FEATURE
...
@@ -696,7 +696,7 @@ BASE_FEATURE(kSupportAddSessionEmailPrefill, base::FEA
