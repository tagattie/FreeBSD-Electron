--- chrome/browser/chrome_content_browser_client.cc.orig	2026-06-23 23:37:18 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
   ...
   if (!content::AreIsolatedWebAppsEnabled(browser_context)) {
     return false;
@@ -2830,7 +2830,9 @@ void ChromeContentBrowserClient::AppendExtraCommandLin
...
@@ -4213,7 +4215,7 @@ std::optional<SkColor> GetRootScrollbarThemeColor(WebC
...
@@ -7672,7 +7674,7 @@ bool ChromeContentBrowserClient::ShouldRunOutOfProcess
