--- chrome/browser/ui/webui/settings/settings_localized_strings_provider.cc.orig	2026-06-23 23:37:18 UTC
...
@@ -600,11 +600,11 @@ void AddAppearanceStrings(content::WebUIDataSource* ht
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
 #if BUILDFLAG(IS_MAC)
@@ -649,7 +649,7 @@ void AddAppearanceStrings(content::WebUIDataSource* ht
...
@@ -1965,7 +1965,7 @@ void AddSignOutDialogStrings(content::WebUIDataSource*
