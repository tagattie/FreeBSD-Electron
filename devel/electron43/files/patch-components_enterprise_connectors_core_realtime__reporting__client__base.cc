--- components/enterprise/connectors/core/realtime_reporting_client_base.cc.orig	2026-06-23 23:37:18 UTC
...
@@ -319,7 +319,7 @@ void RealtimeReportingClientBase::ReportEventWithTimes
