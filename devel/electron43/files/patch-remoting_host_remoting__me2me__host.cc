--- remoting/host/remoting_me2me_host.cc.orig	2026-06-23 23:37:18 UTC
...
@@ -202,7 +202,7 @@ constexpr base::FilePath::CharType kStdinConfigPath[] 
 // from stdin.
...
@@ -854,7 +854,7 @@ void HostProcess::ShutdownOnNetworkThread() {
