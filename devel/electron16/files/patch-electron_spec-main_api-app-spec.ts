--- electron/spec-main/api-app-spec.ts.orig	2022-05-04 15:34:10 UTC
...
@@ -1059,7 +1059,7 @@ describe('app module', () => {
     let w: BrowserWindow;
...
@@ -1200,7 +1200,7 @@ describe('app module', () => {
...
@@ -1218,7 +1218,7 @@ describe('app module', () => {
     });
   });
...
@@ -1268,7 +1268,7 @@ describe('app module', () => {
   });
...
+  ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('getFileIcon() API', () => {
     ...
     const sizes = {
       small: 16,
@@ -1349,7 +1349,7 @@ describe('app module', () => {
...
@@ -1424,7 +1424,7 @@ describe('app module', () => {
