--- electron/shell/browser/api/electron_api_desktop_capturer.cc.orig	2023-01-17 21:24:40 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 std::map<x11::RandR::Output, int> GetMonitors(int version,
                                               x11::RandR* randr,
@@ -294,7 +294,7 @@ void DesktopCapturer::UpdateSourcesList(DesktopMediaLi
