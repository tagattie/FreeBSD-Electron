--- electron/shell/browser/api/electron_api_web_contents.cc.orig	2023-01-17 21:24:40 UTC
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
     ...
     rph->ForceCrash();
@@ -2923,7 +2923,7 @@ void WebContents::CopyImageAt(int x, int y) {
...
+#if BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #endif
@@ -3729,7 +3729,7 @@ ui::ImageModel WebContents::GetDevToolsWindowIcon() {
 }
 #endif
