--- chrome/browser/metrics/chrome_metrics_service_client.cc.orig	2026-01-07 00:52:53 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "chrome/browser/ui/tabs/tab_metrics_provider.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -248,7 +248,7 @@ const char kCrashpadHistogramAllocatorName[] = "Crashp
...
@@ -652,7 +652,7 @@ void ChromeMetricsServiceClient::OnEnvironmentUpdate(s
