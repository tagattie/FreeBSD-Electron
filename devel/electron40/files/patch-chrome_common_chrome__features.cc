--- chrome/common/chrome_features.cc.orig	2026-01-07 00:52:53 UTC
...
@@ -768,7 +768,7 @@ BASE_FEATURE(kGlicGuestContentsVisibilityState,
...
+#if BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT);
@@ -1312,7 +1312,7 @@ BASE_FEATURE(kKAnonymityServiceStorage, base::FEATURE_
 // public keys.
