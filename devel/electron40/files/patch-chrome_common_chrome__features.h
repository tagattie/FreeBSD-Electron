--- chrome/common/chrome_features.h.orig	2026-01-07 00:52:53 UTC
...
@@ -962,7 +962,7 @@ BASE_DECLARE_FEATURE(kKAnonymityServiceStorage);
 COMPONENT_EXPORT(CHROME_FEATURES)
...
@@ -970,7 +970,7 @@ extern const base::FeatureParam<int> kLinuxLowMemoryMo
