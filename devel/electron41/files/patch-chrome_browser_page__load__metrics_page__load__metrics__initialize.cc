--- chrome/browser/page_load_metrics/page_load_metrics_initialize.cc.orig	2026-03-13 16:54:03 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -345,7 +345,7 @@ bool PageLoadMetricsEmbedder::ShouldObserveScheme(std:
