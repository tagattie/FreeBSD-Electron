--- electron/spec-main/api-browser-window-spec.ts.orig	2021-01-22 23:55:24 UTC
...
@@ -1027,7 +1027,7 @@ describe('BrowserWindow module', () => {
         });
       });
...
@@ -1088,7 +1088,7 @@ describe('BrowserWindow module', () => {
         });
       });
...
+    ifdescribe(process.platform === 'linux' || process.platform === 'freebsd')(('Linux'), () => {
       it('sets 1 regardless of parameter', () => {
         ...
         w.setOpacity(0);
@@ -2522,7 +2522,7 @@ describe('BrowserWindow module', () => {
...
@@ -3048,7 +3048,7 @@ describe('BrowserWindow module', () => {
     });
   });
...
+  ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('max/minimize events', () => {
     ...
     it('emits an event when window is maximized', async () => {
       const w = new BrowserWindow({ show: false });
@@ -3626,7 +3626,7 @@ describe('BrowserWindow module', () => {
     });
   });
