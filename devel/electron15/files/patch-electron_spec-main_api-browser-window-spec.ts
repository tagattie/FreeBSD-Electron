--- electron/spec-main/api-browser-window-spec.ts.orig	2021-11-30 20:57:10 UTC
...
@@ -1070,7 +1070,7 @@ describe('BrowserWindow module', () => {
         });
       });
...
@@ -1825,7 +1825,7 @@ describe('BrowserWindow module', () => {
...
+  ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('max/minimize events', () => {
     ...
     it('emits an event when window is maximized', async () => {
       const w = new BrowserWindow({ show: false });
@@ -3704,7 +3704,7 @@ describe('BrowserWindow module', () => {
       });
...
@@ -3796,7 +3796,7 @@ describe('BrowserWindow module', () => {
     });
   });
