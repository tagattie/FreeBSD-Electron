--- media/base/video_frame.cc.orig	2021-09-14 01:51:58 UTC
...
@@ -659,7 +659,7 @@ scoped_refptr<VideoFrame> VideoFrame::WrapExternalGpuM
   return frame;
 }
...
@@ -883,7 +883,7 @@ scoped_refptr<VideoFrame> VideoFrame::WrapVideoFrame(
     }
   }
...
@@ -1239,7 +1239,7 @@ const gpu::MailboxHolder& VideoFrame::mailbox_holder(
...
@@ -1335,7 +1335,7 @@ VideoFrame::VideoFrame(const VideoFrameLayout& layout,
