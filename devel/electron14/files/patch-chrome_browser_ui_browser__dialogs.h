--- chrome/browser/ui/browser_dialogs.h.orig	2021-09-14 01:51:51 UTC
...
@@ -77,7 +77,7 @@ struct SelectedFileInfo;
 }  // namespace ui
...
@@ -174,7 +174,7 @@ void ShowWebAppProtocolHandlerIntentPicker(
