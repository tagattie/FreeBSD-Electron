--- chrome/browser/web_applications/web_app_utils.cc.orig	2021-09-14 01:51:52 UTC
+++ chrome/browser/web_applications/web_app_utils.cc
@@ -211,13 +211,13 @@ std::u16string GetFileTypeAssociationsHandledByWebApps
...
@@ -228,7 +228,7 @@ std::u16string GetFileTypeAssociationsHandledByWebApps
