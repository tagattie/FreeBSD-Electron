--- chrome/common/pref_names.cc.orig	2021-09-14 01:51:52 UTC
+++ chrome/common/pref_names.cc
@@ -1106,7 +1106,7 @@ const char kAllowedDomainsForApps[] = "settings.allowe
...
+#if defined(OS_LINUX) || BUILDFLAG(IS_CHROMEOS_LACROS) || defined(OS_BSD)
 ...
 #endif
@@ -1209,7 +1209,7 @@ const char kShowUpdatePromotionInfoBar[] =
...
@@ -1680,7 +1680,7 @@ const char kDownloadDefaultDirectory[] = "download.def
...
@@ -1959,7 +1959,7 @@ const char kWebAppsPreferences[] = "web_apps.web_app_i
...
+    (defined(OS_LINUX) && !BUILDFLAG(IS_CHROMEOS_LACROS)) || defined(OS_BSD)
 ...
 #endif
@@ -2081,12 +2081,12 @@ const char kAmbientAuthenticationInPrivateModesEnabled
 // requests.
...
@@ -2988,7 +2988,7 @@ const char kAutoplayWhitelist[] = "media.autoplay_whit
...
@@ -2996,7 +2996,7 @@ const char kAllowNativeNotifications[] = "native_notif
