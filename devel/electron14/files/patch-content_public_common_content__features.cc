--- content/public/common/content_features.cc.orig	2021-09-14 01:51:57 UTC
...
@@ -888,13 +888,13 @@ const base::Feature kWebAssemblyBaseline{"WebAssemblyB
...
@@ -911,8 +911,8 @@ const base::Feature kWebAssemblyTiering{"WebAssemblyTi
                                         base::FEATURE_ENABLED_BY_DEFAULT};
...
+     defined(OS_MAC)) &&                                                                \
 ...
 const base::Feature kWebAssemblyTrapHandler{"WebAssemblyTrapHandler",
                                             base::FEATURE_ENABLED_BY_DEFAULT};
@@ -934,7 +934,7 @@ const base::Feature kWebAuthCable {
