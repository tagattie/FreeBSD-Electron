--- chrome/browser/ui/webui/chrome_web_ui_controller_factory.cc.orig	2021-09-14 01:51:51 UTC
...
+#if defined(OS_WIN) || defined(OS_LINUX) || defined(OS_CHROMEOS) || defined(OS_BSD) || \
 ...
 #endif
@@ -535,7 +537,7 @@ bool IsAboutUI(const GURL& url) {
...
@@ -584,8 +586,10 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
...
@@ -983,7 +987,7 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
...
+#if ((defined(OS_LINUX) || defined(OS_CHROMEOS)) && defined(TOOLKIT_VIEWS)) || defined(OS_BSD) || \
   ...
   if (url.host_piece() == chrome::kChromeUITabModalConfirmDialogHost)
     return &NewWebUI<ConstrainedWebDialogUI>;
@@ -1037,13 +1041,13 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
...
@@ -1051,7 +1055,7 @@ WebUIFactoryFunction GetWebUIFactoryFunction(WebUI* we
...
+    (defined(OS_LINUX) || BUILDFLAG(IS_CHROMEOS_LACROS) || defined(OS_BSD))
 ...
 #endif
@@ -1239,8 +1243,10 @@ base::RefCountedMemory* ChromeWebUIControllerFactory::
