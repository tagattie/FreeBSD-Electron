--- third_party/blink/renderer/core/frame/web_frame_test.cc.orig	2021-09-14 01:52:02 UTC
+++ third_party/blink/renderer/core/frame/web_frame_test.cc
@@ -6071,7 +6071,7 @@ TEST_F(WebFrameTest, DISABLED_PositionForPointTest) {
...
@@ -6441,7 +6441,7 @@ TEST_P(CompositedSelectionBoundsTest, SVGBasic) {
