--- third_party/webrtc/modules/video_coding/codecs/h264/h264_decoder_impl.cc.orig	2021-09-14 01:58:34 UTC
...
@@ -211,6 +214,9 @@ int32_t H264DecoderImpl::InitDecode(const VideoCodec* 
