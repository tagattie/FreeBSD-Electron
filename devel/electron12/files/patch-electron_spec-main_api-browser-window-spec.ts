--- electron/spec-main/api-browser-window-spec.ts.orig	2021-04-20 23:32:33 UTC
...
@@ -1034,7 +1034,7 @@ describe('BrowserWindow module', () => {
         });
       });
...
@@ -1095,7 +1095,7 @@ describe('BrowserWindow module', () => {
         });
       });
...
@@ -1723,7 +1723,7 @@ describe('BrowserWindow module', () => {
...
+    ifdescribe(process.platform === 'linux' || process.platform === 'freebsd')(('Linux'), () => {
       it('sets 1 regardless of parameter', () => {
         ...
         w.setOpacity(0);
@@ -2606,7 +2606,7 @@ describe('BrowserWindow module', () => {
...
@@ -3199,7 +3199,7 @@ describe('BrowserWindow module', () => {
     });
   });
...
+  ifdescribe(process.platform !== 'linux' && process.platform !== 'freebsd')('max/minimize events', () => {
     ...
     it('emits an event when window is maximized', async () => {
       const w = new BrowserWindow({ show: false });
@@ -3777,7 +3777,7 @@ describe('BrowserWindow module', () => {
     });
   });
