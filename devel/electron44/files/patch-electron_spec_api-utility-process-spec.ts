--- electron/spec/api-utility-process-spec.ts.orig	2026-08-31 00:54:19 UTC
+++ electron/spec/api-utility-process-spec.ts
@@ -620,7 +620,7 @@ describe('utilityProcess module', () => {
...
@@ -657,7 +657,7 @@ describe('utilityProcess module', () => {
       await closeWindow(w);
     });
